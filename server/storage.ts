...
export class MemStorage implements IStorage {
  ...
  async createWallet(insertWallet: InsertWallet): Promise<Wallet> {
    ...
    const wallet: Wallet = { 
      ...
      cathValueInSol: insertWallet.cathValueInSol ?? "0",
      holdingsCheckedAt: null,
      appPurchased: insertWallet.appPurchased ?? false,
      appPurchasedAt: null,
      appPurchaseTxSignature: insertWallet.appPurchaseTxSignature ?? null,
      baseFeeStatus: insertWallet.baseFeeStatus ?? "current",
      baseFeeNextDue: null,
      baseFeeLastPaidAt: null,
      baseFeeWaivedReason: insertWallet.baseFeeWaivedReason ?? null,
      paidTier: insertWallet.paidTier ?? "none",
      paidTierStatus: insertWallet.paidTierStatus ?? "none",
      paidTierMethod: insertWallet.paidTierMethod ?? null,
      paidTierNextDue: null,
      paidTierLastPaidAt: null,
      paymentPreference: insertWallet.paymentPreference ?? "SOL",
      id,
